...
The application has been adapted to the Openshift Container Platform and this repo goes over the processes required to set up the application in the Openshift Container Platform as well as requirements to utilize the [Mautic Subscription App](https://github.com/bcgov/Mautic-Subscription-App).
